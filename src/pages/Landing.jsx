...
const Landing = () => {
  ...
  return (
    <div className={styles.landing}>
      ...
      <Motion.section
        className={`container ${styles.features} relative z-10 flex flex-col gap-0`}
        initial="hidden"
        whileInView="show"
      ...
      >
        ...
        >
          <Feature3D
            ...
            icon={<Building size={40} color="#8b5cf6" />}
      ...
      <Motion.section
        ...
        viewport={{ once: true }}
      >
        <h2 className={`${styles.sectionHeading} text-center mb-10`}>
          Trusted by Leaders
        </h2>
        <InfiniteMovingCards
          items={testimonials}
...
const Feature3D = ({ title, desc, icon, imgUrl, containerClassName }) => {
  return (
    ...
    >
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-blue-500/[0.2] dark:bg-[#0f172a] dark:border-white/[0.1] border-black/[0.1] w-auto sm:w-[18rem] h-auto rounded-xl p-6 border transition-all duration-300">
        <CardItem
          translateZ="50"
...
const testimonials = [
  {
    ...
    title: "Research Inst.",
    quote:
      "Verifying degrees for our researchers is now instant and trustless.",
  },
  {
    name: "MIT",
    title: "University",
    quote: "Issuing digital diplomas has cut our admin costs by 90%.",
  },
  {
    name: "Google",
    title: "Tech Giant",
    quote: "We only hire candidates with verified on-chain credentials now.",
  },
  {
    name: "Ethereum Fdn",
    title: "Non-Profit",
    quote: "The standard for academic identity on the blockchain.",
  },
];
