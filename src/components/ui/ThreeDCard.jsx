...
import { MouseEnterContext, useMouseEnter } from "./ThreeDCardContext";
    ...
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      ...
      >
        <div
          ...
          style={{transformStyle: 'preserve-3d', transition: 'all 0.2s linear'}}
        >
          {children}
          {revealText}
        </div>
...
export const CardItem = (props) => {
  ...
  return (
    <Tag
      ...
      style={{width: 'fit-content', transition: 'all 0.2s linear'}}
      {...rest}
    >
      {children}
    </Tag>
